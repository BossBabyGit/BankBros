...
const CSBATTLE_END_ISO = "2026-01-06T20:00:00-05:00";  // Nov 19, 2025 20:00 EST (UTC-5)
...
{/* Active Leaderboard Countdown */}
            <div className="mb-8">
              <div className="flex items-center justify-center gap-4">
                <TimeTile label="Days" value={countdown.days} />
                <TimeTile label="Hours" value={countdown.hours} />
                <TimeTile label="Minutes" value={countdown.minutes} />
                <TimeTile label="Seconds" value={countdown.seconds} />
              </div>
